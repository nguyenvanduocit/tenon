...
| `TENON-PRD-004` | [`settings`](settings.prd.md) ([Gherkin](settings.feature)) | application and plugin settings, defaults, persistence, and personalization | shipped; current-source audited in canonical PRD/Gherkin, plugin runtime constraints remain cross-linked to PRD-010 | T-002 |
...
| `TENON-PRD-010` | [`plugin-runtime`](plugin-runtime.prd.md) ([Gherkin](plugin-runtime.feature)) | discovery, manifests, low-friction installation permission policy, trust, capabilities, built-ins, events, resource lifetime, hot reload, logs, and user-plugin placement | partial; simplified local enable/authority review, hard OS isolation, and process-stream descendant containment remain open | T-017, T-018, T-021, T-033, T-037, T-049, T-053, T-062, T-080, T-093 |
