---
title: filesystem.directory.create.v1
...
Creates one directory without implicitly creating its ancestors.
...
```js
const result = await tenon.intents.send("filesystem.directory.create.v1", {})
...
```sh
tenon-cli intent send filesystem.directory.create.v1 --input '{}'
```

Ask your own build for this same contract with `tenon-cli intent describe filesystem.directory.create.v1`.
