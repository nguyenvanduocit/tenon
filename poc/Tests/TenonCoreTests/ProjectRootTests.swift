...
final class ProjectRootTests: XCTestCase {
    ...
    func testResolvesALinkedWorktreeWhereGitIsAFile() throws {
        ...
        let deep = try directory("agent-worktree/poc/Sources")
    ...
    func testCrossingIntoALinkedWorktreeDoesReRootThePanels() throws {
        ...
        let before = ProjectRoot.resolve(cwd: try directory("main/poc"))
        let after = ProjectRoot.resolve(cwd: try directory("agent-worktree/poc"))
