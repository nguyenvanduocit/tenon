#!/usr/bin/env bash
# prune-build-cache.sh — delete regenerable build junk from poc/.build before a build.
#
# Tenon builds through exactly two trees, both inside the gitignored poc/.build:
#
