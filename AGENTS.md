...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-24. Confidence: 100%.
...
- `poc/plugins/git/main.js`
- `poc/plugins/hello-palette/main.js`
- `poc/plugins/workspace-status/main.js`

### Code health
Three co-equal signals: defect risk 9.83/10 avg, hotspot health 9.83/10 (stable), worst `poc/Resources/ghostty/shell-integration/bash/ghostty.bash` at 6.89/10 · maintainability 9.84/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
